...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listWidget_chei.sizePolicy().hasHeightForWidth())
        self.listWidget_chei.setSizePolicy(sizePolicy)
        self.listWidget_chei.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.listWidget_chei.setResizeMode(QtWidgets.QListView.Fixed)
        self.listWidget_chei.setUniformItemSizes(False)
        self.listWidget_chei.setWordWrap(False)
